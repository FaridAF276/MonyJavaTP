...
public class MoneyTest extends TestCase{
    ...
    public void testAdd()throws Exception {
        System.out.println("Add Money Test");
        Money m = new Money(2, "Euro");
        Money instance = new Money(3,"Euro");
        Money expResult = new Money(5, "Euro");
        Money result = instance.add(m);
        assertTrue("They are Equals", result.amount()==expResult.amount() && result.currency().equals(expResult.currency()));
    }
